...
The MicroProfile Catalog Service is a modern Jakarta EE 10 application built with MicroProfile specifications and running on Open Liberty. This service provides a RESTful API for product catalog management with enhanced MicroProfile features and flexible persistence options.
