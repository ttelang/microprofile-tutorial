...
This microservice demonstrates MicroProfile Fault Tolerance patterns for building resilient payment processing services. It is part of the Jakarta EE 10 and MicroProfile based e-commerce tutorial.
...
* **Configuration Externalization** via MicroProfile Config
