...
NOTE: This tutorial is based on MicroProfile 7.1 Platform, the latest version of the specification optimized for cloud-native microservices development.
...
.MicroProfile Specifications
image::https://microprofile.io/wp-content/uploads/2024/11/microprofile_release_7.0.png[MicroProfile 7.0 Specifications]
...
| link:https://microprofile.io/specifications/microprofile-opentracing/[Open Tracing]| *(Archived - replaced by Telemetry in MicroProfile 6.1+)* Integrates distributed tracing by defining a way for services to trace requests across service boundaries, improving observability.
|=======================
