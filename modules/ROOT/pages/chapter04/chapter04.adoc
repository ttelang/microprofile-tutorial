...
public class CustomModelReader implements OASModelReader {
    ...
    public OpenAPI buildModel() {
        return OASFactory.createOpenAPI()
            ...
            // Alternative: Use pure JSON Schema 2020-12. Use this ONLY if you need strict compatibility                // with external tools that do not recognize OpenAPI-specific keywords.
