...
For more complex scenarios with multiple event types, you can use webhooks. The code example shows a webhook subscription system with different event types:
