...
public class ProductResource {
    ...
    @APIResponses(value = {
        @APIResponse(
            responseCode = "200",
            description = "Successful retrieved product list",
            content = @Content(
...
* *@Content*: Specifies the response media type and structure. In this example, the response content is a list of `Product`s.
