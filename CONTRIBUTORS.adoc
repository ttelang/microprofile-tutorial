...
:toclevels: 3
:doctype: book
:description: Guidelines for contributing documentation, fixes, and improvements
:keywords: contribution, guidelines, github, antora
...
2. Install Antora: `npm install -g @antora/cli`
3. Build locally: `./dev-server.sh watch`
4. Make your changes in `modules/ROOT/pages/`
5. Submit a PR
====
...
* link:https://docs.asciidoctor.org/[AsciiDoc Reference]
* link:https://github.com/microprofile/microprofile-tutorial-ui[UI Bundle Repository]
