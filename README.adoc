...
**Chapter 11** has been comprehensively updated to reflect these changes:

* All dependency versions updated to MicroProfile Rest Client 4.0
* Code examples demonstrate the new `baseUri(String)` method
* Added Jakarta EE 10 compatibility notes
* Clarified CDI injection requirements with `@RestClient` qualifier
* Updated Maven and Gradle dependency configurations
